...
var allShapes = [];
// allShapes.push(blob1);

/***** CODE EXECUTION *****/
document.onkeydown = keydown;
setUpCanvas();
//createSeaUrchins(allSeaUrchins, 5);
//createJellies(allJellies, 10);
console.log(allShapes);
animationLoop();

//document.getElementById("button").onclick = animationLoop();
// document.querySelector("#button").onclick = click;
// function click(event) {
//     clear();
//     cancelAnimationFrame(animationLoop);
//     for (var i = 0; i < allJellies.length; i++) {
//         for (keys in allJellies[i].change) {
//             allJellies[i].change[keys] = 0;
//         }
//     }
//     for (var i = 0; i < allSeaUrchins.length; i++) {
//         for (keys in allSeaUrchins[i].change) {
//             allSeaUrchins[i].change[keys] = 0;
//         }
//     }
//     allSeaUrchins = [];
//     allJellies = [];
...
function animationLoop() {
    clear();
    document.getElementById("score").innerText = "Score: " + scoreCounter().getCurrentScore();
    document.getElementById("lives").innerText = "Lives: " + livesCounter().getCurrentLives();
